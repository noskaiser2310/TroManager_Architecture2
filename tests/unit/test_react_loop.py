...
class TestReActAgent:
    ...
    def agent(self, mock_llm, mock_context_builder, mock_guardrails,
        ...
        return ReActAgent(
            ...
            system_prompt="Test prompt {tenant_name} {tone} {lease_end} {payment_delay_days} {memories} {behavior_summary} {query} {history_context} {tool_descriptions} {current_date}",
        )
...
class TestGuardrails:
    ...
    def test_sensitive_tool_detection(self):
        ...
        assert guardrails.is_sensitive_tool("send_zalo") is True
